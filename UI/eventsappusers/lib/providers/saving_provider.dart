...
class SavingProvider with ChangeNotifier {
  ...
  Future<bool> isSaved(dynamic filter) async {
    var url = "$_baseUrl$_endpoint/is-saved";
  ...
  Future<bool> save(dynamic request) async {
  ...
  Future<bool> delete(dynamic request) async {
    var url = "$_baseUrl$_endpoint";
    var uri = Uri.parse(url);
    var headers = BaseProvider.createHeaders();
